...
def barra_menu(root):
    ...
    menu_inicio.add_command(label='Salir registro', command=root.destroy)
...
class Frame(tk.Frame):
    ...
    def campos_peliculas(self):
        ...
        self.label_duracion.config(font=('Times New Roman', 12, 'bold'))
        ...
        self.entry_duracion.config(width=50,font=('Times New Roman', 12))
    ...
    def tabla_peliculas(self):
        ...
        self.boton_editar.config(width=20, font=('Times New Roman', 12, 'bold'), fg='white', bg='SpringGreen3', cursor='hand2', activebackground='SeaGreen2')
